...
void FileReader::compute_file(ifstream &in_file) {
	Paraula sparaula;
	string paraula;
...
void FileReader::search_element(string paraula, bool& is_there, int & pos_element)const {
...
void  FileReader::incertarOrdenadament(Paraula araula) {
...
void FileReader::mostraHistograma()const {
...
bool FileReader:: es_separador(char lletra)  {
	/*Pre: cert
 ...
 void FileReader :: passar_separadors(ifstream& fitxer)  {
	/*Pre: fitxer obert
...
string FileReader::passar_paraula(ifstream& fitxer) {
